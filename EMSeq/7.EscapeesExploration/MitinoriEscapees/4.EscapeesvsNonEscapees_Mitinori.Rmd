---
title: 'Comparison escapees vs non-escapees - list provided by Mitinori lab'
author: 'Gaja Matassa'
...
bsseq_obj_NonEscapees <- readRDS(paste0(params$InputFolder, "bsseq_obj_NonEscapees_Murase.rds"))
```
