---
title: "Exploratory Data Analysis of Hsu et al bACEseq"
author: "Gaja Matassa"
...
output:
    html_document:
        ...
        code_folding: hide
params: 
    InputFolder: '~/DataDir/7.EscapeesExploration/bACEseq_Hsu'
    OutputFolder: '~/DataDir/7.EscapeesExploration/bACEseq_Hsu/Output/'
---
...
-   The number of CpGs covered by at least 60% of samples of the same type in the BSSeq object is `r dim(methylSig::filter_loci_by_group_coverage(bs = bsseq_obj,group_column = "Type", min_samples_per_group = c('D4hPGCLC' = 4, 'hESC' = 3, 'hESC_KO' = 2)))[1]`.
